package com.zerogravityapp.freehandworkout_loseweightin30days.ui.dumbleExercise;
...
public class DumbleExcerciseAdapter extends BaseAdapter {
    private Context c;
    private List<freehandExerciseObject> freehandExerciseObjectList;

    public DumbleExcerciseAdapter(Context c, List<freehandExerciseObject> freehandExerciseObjectList) {
        this.c = c;
