package com.zerogravityapp.freehandworkout_loseweightin30days.ui.FastFatLoss;
...
import com.zerogravityapp.freehandworkout_loseweightin30days.ui.home.freehandExerciseObject;
...
public class FastFatlossFragment extends Fragment {
    ...
    void createDataObject(){
        ...
        freehandExerciseObject obj7=new freehandExerciseObject("Skipping",R.drawable.skipping,"100 times","Surprisingly, skipping ropes can burn 10 calories in a minute and also strengthen your legs, butt, shoulders, belly, and arms. An average, you can burn 200 calories in 10 minutes session of each day. It is more effective than brisk walking.\n" +
                "\n" );
        ...
        freehandExerciseObject obj8=new freehandExerciseObject("Ropping",R.drawable.ropping,"3 reps(15 times)",
                "The benefits of rope training include increased power, strength, flexibility, and endurance. The end result of consistent heavy ropes workouts is toned muscles and burned fat. A few whips of these heavy ropes propel one's heart to its maximum rate." );
