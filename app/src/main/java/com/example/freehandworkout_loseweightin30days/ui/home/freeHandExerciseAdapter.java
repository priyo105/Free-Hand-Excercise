...
public class freeHandExerciseAdapter extends BaseAdapter {
    private Context c;
    private List<freehandExerciseObject> freehandExerciseObjectList;

    public freeHandExerciseAdapter(Context c, List<freehandExerciseObject> freehandExerciseObjectList) {
        this.c = c;
